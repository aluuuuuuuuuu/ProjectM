	...
	_charactorNum(charNum)
{
	...
	// 選択後画像のロード
	{
		_cardSelectHandle[PLAYER_1 - 1] = LoadGraph("data/image/CardSelectedRed.png");
		_cardSelectHandle[PLAYER_2 - 1] = LoadGraph("data/image/CardSelectedBlue.png");
		_cardSelectHandle[PLAYER_3 - 1] = LoadGraph("data/image/CardSelectedGreen.png");
		_cardSelectHandle[PLAYER_4 - 1] = LoadGraph("data/image/CardSelectedYellow.png");
	}
